package io.capstone.ludendorff.components.views;
...
import io.capstone.ludendorff.components.custom.MonthViewAdapter;

public class MonthPickerView extends FrameLayout {

    YearPickerView _yearView;
    ListView _monthList;
    public static int _minYear = 1900, _maxYear = Calendar.getInstance().get(Calendar.YEAR);
    MonthViewAdapter _monthViewAdapter;
    public TextView _month, _year, _title;
    Context _context;
    ...
    */
    ...
    public void setOnConfigurationChanged(MonthPickerDialog.OnConfigChangeListener configChangeListener){
